...
<form action="mylcregister.php" method="post">
    <fieldset>
        <div class="form-group">
            <input autofocus class="form-control" name="username" placeholder="Enter a Username"  type="text" align="center"/>
        </div>
        <div class="form-group">
            <input class="form-control" name="password" placeholder="Choose a Password" type="password" align="center"/>
        <div class="form-group">
        <input class="form-control" name="confirmation" placeholder="Confirm Password" type="password" align="center"/>
        </div>
        </div>
        <div class="form-group">
            <button type="submit" class="m-btn">Register for an Account</button>
        </div>
